...
def stratify_split(data_source, n_splits=1, val_size=0.3, random_state=69):
...
class StratifiedSampler(Sampler):
    def __init__(self, data_source, n_splits, val_size, random_state, sample_train=True):
        self.train_idx, self.val_idx = stratify_split(data_source, n_splits, val_size, random_state)
